...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="jsp/index.jsp">X-admin v2.0</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            <a href="javascript:;">${userinfophone[0].userinfophone}</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a onclick="x_admin_show('个人信息','http://www.baidu.com')">个人信息</a></dd>
              <dd><a onclick="x_admin_show('切换帐号','http://www.baidu.com')">切换帐号</a></dd>
              <dd><a href="/userinfo/queit">退出</a></dd>
            </dl>
          </li>
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="userinfo/find_userinfoadmin">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表</cite>
                        </a>
                    </li >
