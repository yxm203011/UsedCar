...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" action="/carbrand/update_carbrand" id="form1">
          <div class="layui-form-item">
              <label for="carbrandname" class="layui-form-label">
                  <span class="x-red">*</span>品牌名
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="carbrandname" value="${carbrand[0].carbrandname}" name="carbrandname" required="" lay-verify="required"
                  autocomplete="off" class="layui-input">
                  <input type="text" value="${carbrand[0].carbrandicon}" name="imgurl" style="opacity:0" id="imgurl">
              </div>
          </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" readonly value="${carbrand[0].carbrandlogogram}">
                  <input type="text" value="${carbrand[0].carbrandid}" name="carbrandid" style="opacity:0">
              </div>
          </div>
      </form>
        <div class="layui-upload">
            <div class="layui-upload-list">
                ...
                <form id="fm" enctype="multipart/form-data" method="post">
                    ...
                    <img src="images/${carbrand[0].carbrandicon}" style="height:100px;width:100px;position: relative; margin-left:-60px;" id="upimg">
