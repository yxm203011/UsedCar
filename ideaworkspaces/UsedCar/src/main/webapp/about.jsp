	...
	<div class="head-search">
        ...
        <input type="submit" value="搜 索" class="right" />
			...
			<div class="hotWords left dInline">
				热门品牌：<a href="javascript:;">奥迪A6L</a><a href="xl2412_pp3.jsp">宝马5系</a><a href="xl1987_pp2.jsp">奔驰E级</a><a href="xl2593_pp9.jsp">奥迪A4L</a><a href="javascript:;">奔驰C级</a>
			</div>
		</div>
	</div>
</div>
...
<div id="about">
	<div class="mTags wrap">
		<a href="javascript:;">亿金名车广场</a>><a href="36">亿金简介</a>
	</div>
	<div class="wAbout">
		<div class="a-wa">
			<div class="wrap a-nav">
				<ul class="clearfix">
					<li class="on"><a href="javascript:;">亿金简介</a></li><li><a href="javascript:;">亿金优势</a></li><li><a href="javascript:;">亿金风采</a></li><li><a href="javascript:;">亿金荣誉</a></li><li><a href="javascript:;">亿金动态</a></li><li><a href="javascript:;">售后服务</a></li><li><a href="javascript:;">招贤纳士</a></li><li><a href="javascript:;">联系我们</a></li></ul>
			</div>
		</div>
		<div class="a-wb">
			<div class="wrap">
	...
	<div class="foot-a">
		<div class="wrap clearfix">
			...
			<div class="fDl left dInline ">
				...
				<ul>
					<li><a href="javascript:;" target="_blank">《美人鱼》里的主演都开什</a></li>
			...
			<div class="fDl left dInline ">
				<strong>关于亿金</strong>
				<ul>
					<li><a href="30.jsp" target="_blank">亿金动态</a></li>
					<li><a href="39.jsp" target="_blank">亿金荣誉</a></li>
					<li><a href="37.jsp" target="_blank">亿金优势</a></li>
					<li><a href="41.jsp" target="_blank">联系亿金</a></li>
					<li><a href="42.jsp" target="_blank">评估团队</a></li>
				</ul>
			</div>
			<div class="fDl left dInline ">
				<strong>亿金文化</strong>
...
<script type="text/javascript" src="Scripts/838affd8855a43bca79b697203a0a050.js"></script>
